...
public abstract class ContainerEnergyTerminalDuality extends ContainerWithPlayerInventory implements IMEMonitorHandlerReceiver<IAEFluidStack>, IEnergySelectorContainer, ICraftingIssuerContainer {
     ...
     *
     */
    private boolean attachToMonitor( final IMEMonitor<IAEFluidStack> eMonitor )
    {
                                                             ...
                                                             final Actionable mode )
    {
        ...
        long rejectedAmount = this.energyMonitor.injectItems(AEApi.instance().storage().createFluidStack(new FluidStack(containerEnergy.getEnergy(),amount)), mode, actionSource).getStackSize();
                                                            ...
                                                            final BaseActionSource actionSource, final Actionable mode )
    {
        ...
        long extractedAmount = this.energyMonitor.extractItems(AEApi.instance().storage().createFluidStack(new FluidStack(withEnergy,containerCapacity)), mode, actionSource ).getStackSize();
