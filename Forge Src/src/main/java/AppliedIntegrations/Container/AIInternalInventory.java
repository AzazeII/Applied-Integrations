 ...
 * @Author Azazell
 */
public class AIInternalInventory
        implements IInventory
{
     ...
     * @param stackLimit
     */
    public AIInternalInventory(final String customName, final int size, final int stackLimit )
    {
    ...
    {
        return AIUtils.canPlayerInteractWith( player, tile );
    }
    ...
    public final void readFromNBT( final NBTTagCompound data, final String tagName )
    {
        ...
        for( int index = 0; index < invList.tagCount(); index++ )
        {
            ...
            // Get the slot number
            int slotIndex = nbtCompound.getByte( AIInternalInventory.NBT_KEY_SLOT ) & 0xFF;
    ...
    public final void writeToNBT( final NBTTagCompound data, final String tagName )
    {
        ...
        for( int slotIndex = 0; slotIndex < this.slots.length; slotIndex++ )
        {
            ...
            if( this.slots[slotIndex] != null )
            {
                ...
                // Set the slot number
                nbtCompound.setByte( AIInternalInventory.NBT_KEY_SLOT, (byte)slotIndex );
