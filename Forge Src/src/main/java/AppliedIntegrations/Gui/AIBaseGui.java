        ...
        implements IWidgetHost
{
    ...
    {
        return AIGuiHelper.INSTANCE.isPointInGuiRegion( slot.yDisplayPosition, slot.xDisplayPosition, 16, 16, x, y, this.guiLeft, this.guiTop );
    }
    ...
    protected final void drawAEToolAndUpgradeSlots( final float alpha, final int mouseX, final int mouseY )
    {
        ...
        for( int i = 0; i < this.inventorySlots.inventorySlots.size(); i++ )
        {
            ...
            {
                // Draw background
                this.drawTexturedModalRect( this.guiLeft + slot.xDisplayPosition-3, this.guiTop + slot.yDisplayPosition-5, AIBaseGui.upgradeU,
