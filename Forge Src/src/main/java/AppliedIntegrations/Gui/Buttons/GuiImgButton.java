...
public class GuiImgButton extends AIStateButton implements ITooltip
{
    ...
    public GuiImgButton(int ID, final IWidgetHost hostGUI,final int x, final int y, final Enum idx, final Enum val )
    {
        super(	ID, x, y, 16, 16, null,64,
                64, AEStateIconsEnum.TAB_BUTTON );
    ...
    public void setCurrentValue(Enum val){
        this.currentValue = val;
    }
    ...
    public void getTooltip(List<String> tooltip) {
        if(this.buttonSetting == Settings.POWER_UNITS) {
            PowerUnits unitValue = (PowerUnits) this.currentValue;
            tooltip.add("PowerUnit: " + unitValue.toString());
        }
    }
