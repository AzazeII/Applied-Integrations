...
public final class AIGuiHelper
{
    ...
    /**
     * Maps energies to chat colors.
     */
    private HashMap<LiquidAIEnergy, String> colors = new HashMap<LiquidAIEnergy, String>();
    ...
    /**
     * Gets the chat color associated with the specified energy.
     *
     * @param energy
     * @return
     */
    public final String getenergyChatColor( final LiquidAIEnergy energy )
    {
        if( this.colors.containsKey( energy ) )
        {
            return this.colors.get( energy );
        }
