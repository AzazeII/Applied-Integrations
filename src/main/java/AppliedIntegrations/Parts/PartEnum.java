...
public enum PartEnum {
	EnergyImportBus(AIStrings.Part_EnergyImportBus, PartEnergyImport.class, ItemEnum.ITEMPARTIMPORT, AppliedIntegrations.modid + ".group.energy.transport", generatePair(Upgrades.CAPACITY, 2), generatePair(Upgrades.REDSTONE, 1), generatePair(Upgrades.SPEED, 2)),
	...
	EnergyExportBus(AIStrings.Part_EnergyExportBus, PartEnergyExport.class, ItemEnum.ITEMPARTEXPORT, AppliedIntegrations.modid + ".group.energy.transport", generatePair(Upgrades.CAPACITY, 2), generatePair(Upgrades.REDSTONE, 1), generatePair(Upgrades.SPEED, 2)),
