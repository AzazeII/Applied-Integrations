...
public class GuiEnergyTerminalDuality extends AIBaseGui implements IEnergySelectorGui {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		// Draw energy name
		{
			this.fontRenderer.drawString("Energy: " + this.selectedStack.getEnergy().getEnergyName(), 45, 101, 0);
		}
		...
		// Draw energy amount
		{
			this.fontRenderer.drawString("Amount: " + this.selectedStack.amount, 45, 91, 0);
		}
