...
public final class QEUtils
{
	...
	public static final boolean canPlayerInteractWith( @Nonnull final EntityPlayer player, @Nonnull final TileEntity tile )
	{
		...
		// Range check
		return( player.getDistanceSq( tile.xCoord + 0.5D, tile.yCoord + 0.5D, tile.zCoord + 0.5D ) <= QEUtils.SQUARED_REACH );
